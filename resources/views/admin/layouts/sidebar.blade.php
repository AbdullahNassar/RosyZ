<div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        <li class="nav-item start " style="margin-top: 20px;">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item ">
                                    <a href="{{route('admin.subs')}}" class="nav-link ">
                                        <i class="icon-bar-chart"></i>
                                        <span class="title">Sub Categories</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a href="{{route('admin.stories')}}" class="nav-link ">
                        ...
                        <li class="nav-item  ">
                            <a href="{{route('admin.data')}}" class="nav-link nav-toggle">
                                <i class="icon-bar-chart"></i>
