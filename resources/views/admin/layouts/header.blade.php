<!-- BEGIN HEADER -->
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                <!-- BEGIN LOGO -->
                <div class="page-logo">
                        <a href="{{route('admin.home')}}" style="margin-top: 12px; margin-left: 15px; margin-bottom: 15px;"><img src="{{asset('assets/admin/images/logo.png')}}" alt="" style="max-width: 130px;" />
                        </a> 
