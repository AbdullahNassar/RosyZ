...
Route::group(['namespace' => 'Site'], function () {
    ...
    Route::get('/delete/{id}', ['as' => 'wishlist.delete', 'uses' => 'WishListController@delete']);
    Route::get('/profile', ['as' => 'site.profile', 'uses' => 'MembersController@getIndex']);
    Route::post('/profile', ['as' => 'profile.update', 'uses' => 'MembersController@update']);
...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin'], function () {
    ...
    Route::group(['middleware' => 'auth.admin'], function () {
        ...
        Route::group(['prefix' => 'subs'], function () {
            Route::get('/', ['as' => 'admin.subs', 'uses' => 'SubsController@getIndex']);
            Route::get('/add', ['as' => 'admin.sub.add', 'uses' => 'SubsController@getAdd']);
            Route::post('/add', ['as' => 'admin.sub.add', 'uses' => 'SubsController@insert']);
            Route::get('/edit/{id}', ['as' => 'admin.sub.edit', 'uses' => 'SubsController@getEdit']);
            Route::post('/edit/{id}', ['as' => 'admin.sub.edit', 'uses' => 'SubsController@postEdit']);
            Route::get('/delete/{id}', ['as' => 'admin.sub.delete', 'uses' => 'SubsController@delete']);
        });
